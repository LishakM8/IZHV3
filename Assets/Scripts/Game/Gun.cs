...
public class Gun : MonoBehaviour
{
    ...
    public void ShootGun(Transform director)
    {
        ...
        for (int i = 0; i < shotgunBullets; i++)
        {
            ...
            {
                SpawnBullet(bulletPosition, bulletRotation * Quaternion.Euler(0,shotgunSpread*(i - shotgunBullets/2) + shotgunSpread/2,0));
            }
            else
            {
                SpawnBullet(bulletPosition, bulletRotation * Quaternion.Euler(0,shotgunSpread*(i - shotgunBullets/2),0));
            }
        }
